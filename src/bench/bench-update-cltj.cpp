...
int main(int argc, char **argv) {
  ...
  if (ratio < 1) {
    ...
    if (type == "normal") {
      query_qpu<cltj::compact_dyn_ltj, ltj::util::trait_distinct>(
          index, qs, us, limit, qpu
      );
    } else if (type == "star") {
      query_qpu<cltj::compact_dyn_ltj, ltj::util::trait_size>(
          index, qs, us, limit, qpu
      );
    } else {
    ...
    if (type == "normal") {
      query_upq<cltj::compact_dyn_ltj, ltj::util::trait_distinct>(
          index, qs, us, limit, upq
      );
    } else if (type == "star") {
      query_upq<cltj::compact_dyn_ltj, ltj::util::trait_size>(
          index, qs, us, limit, upq
      );
    } else {
      std::cout << "Type of index: " << type << " is not supported."
