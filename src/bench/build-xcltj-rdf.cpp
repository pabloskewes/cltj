...
int main(int argc, char **argv) {
  try {
    ...
    auto stop = timer::now();
    cout << "Mapping: " << duration_cast<seconds>(stop - start).count()
         << " seconds." << endl;
    D.shrink_to_fit();
    ...
    stop = timer::now();
    cout << "Dictionaries: " << duration_cast<seconds>(stop - start).count()
         << " seconds." << endl;
    ...
    std::cout << "Size index : " << sdsl::size_in_bytes(index) << " (bytes)"
              << std::endl;
    std::cout << "Size dictP : " << sdsl::size_in_bytes(dict_p) << " (bytes)"
              << std::endl;
    std::cout << "Size dictSO: " << sdsl::size_in_bytes(dict_so) << " (bytes)"
              << std::endl;
