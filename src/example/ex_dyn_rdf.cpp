...
int main(int argc, char **argv) {
  typedef cltj::xcltj_rdf_dyn::tuple_type tuple_type;
  {
    ...
    std::string query = "?x <http://www.wikidata.org/prop/direct/P8> ?y . ?z "
                        "<http://www.wikidata.org/prop/direct/P13> ?y";
    ...
    std::cout << std::endl;
    res.clear();
    cltj.insert("<http://www.wikidata.org/entity/Q5> "
                "<http://www.wikidata.org/prop/direct/P13> "
    ...
    std::cout << std::endl;
    res.clear();
    cltj.remove("<http://www.wikidata.org/entity/Q5> "
                "<http://www.wikidata.org/prop/direct/P13> "
                "<http://www.wikidata.org/entity/Q6>");
    cltj.query(query, res);
    for (uint64_t i = 0; i < res.size(); ++i) {
